...
(function (root, factory) {
    ...
    function durationFormat() {
        ...
        // Trim Small.
        if (trimSmall && momentTypes.length > 1 && !outputTypes) {
        ...
        // Trim Final.
        if (trimFinal && momentTypes.length === 1 && !momentTypes[0].wholeValue && !(!trunc && momentTypes[0].isSmallest && momentTypes[0].rawValue < minValue) && !outputTypes) {
            momentTypes = [];
        }
        ...
        // Largest.
        if (largest && momentTypes.length && !outputTypes) {

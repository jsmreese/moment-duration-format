...
(function (root, undefined) {
	...
	moment.duration.fn.format = function () {
		...
		tokens = map(tokens, function (token, index) {
			...
			//	val = (Math[settings.trunc ? "floor" : "round"](token.wholeValue * Math.pow(10, settings.precision)) * Math.pow(10, -settings.precision)).toString();
			//} else {
	...
	moment.duration.fn.format.defaults = {
		...
		// trunc
		// default behavior in version 2.0.0 will round final value
		// set to `true` to truncate final value (this was the default behavior in version 1)
		trunc: false,

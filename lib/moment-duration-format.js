...
(function (root, factory) {
    ...
    function durationFormat() {
        ...
        if (trim === null && (largest || minValue || maxValue)) {
            trim = "all";
        }
        ...
        momentTypes = map(momentTypes, function (momentType, index) {
            ...
            if (isSmallest && minValue && settings.duration.as(momentType) < minValue) {
                isMinValue = true;
            }
            ...
            // Update remainder.
            if (isMaxValue) {
                remainder = moment.duration(0);
                remainderMonths = moment.duration(0);
            } else {
        ...
        var formatValue = function (momentType, index) {
            ...
            if (isMaxValue && momentType.isLargest) {
                momentType.wholeValue = maxValue;
                momentType.decimalValue = 0;
            }

            if (isMinValue && momentType.isSmallest) {
